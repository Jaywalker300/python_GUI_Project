#All imports
from PyQt5.QtWidgets import QApplication, QWidget,QCheckBox, QLabel, QMessageBox,QFileDialog, QLineEdit,QPushButton,QVBoxLayout,QHBoxLayout,QTreeView,QMainWindow
...
class FinanceApp(QMainWindow):
    ...
    def save_data(self):
        ...
        if dir_path:
            ...
            QMessageBox.information(self, "Save Results","Results were saved successfully")

        else:
            QMessageBox.warning(self, "Save Results", "Unable to save file")            
